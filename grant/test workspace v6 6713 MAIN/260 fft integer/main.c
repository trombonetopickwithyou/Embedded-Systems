...
int main(void)
{
	...
	Downscale(DATAREAL, DATAIMAG, XDATAREAL, XDATAIMAG);		// shift down by 8 bits
	Downscale(XDATAREAL, XDATAIMAG, DATAREAL, DATAIMAG);		// shift down another 8 bits
	return 0;
} // main
//---------------------------------------------------------------------------
...
BitReverse (TRANSREAL, TRANSIMAG, OutX, OutY);
} // ComplexFFT
//---------------------------------------------------------------------------
