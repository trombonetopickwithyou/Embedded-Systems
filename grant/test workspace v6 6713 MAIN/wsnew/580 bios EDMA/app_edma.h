#ifndef BIOS_EDMA_APP_EDMA_H_
#define BIOS_EDMA_APP_EDMA_H_
...
EDMA_Config cfgEdmaPing_rx = {  
  ...
  EDMA_SRC_OF(0x01900000u),/* Source address register 
                               &ping_data    - source address                */
  
  EDMA_CNT_OF(0x3F0002),   /* Transfer count parameter
  ...
  EDMA_IDX_OF(0xFF820080),/* Index parameter                                 */
...
EDMA_Config cfgEdmaPing_tx = {  
  ...
  EDMA_DST_OF(0x01900004u),      /* Destination address parameter
                                 ping - destination address                  */ 
