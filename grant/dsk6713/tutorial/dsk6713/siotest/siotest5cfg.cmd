...
_trace = trace;
_myLog = myLog;
_inStreamSrc = inStreamSrc;
_outStreamSrc = outStreamSrc;
_inStreamSink = inStreamSink;
_outStreamSink = outStreamSink;
...
SECTIONS {
       ...
       .hst0: align = 0x4 {} > IRAM
        ...
        /* LOG_system buffer */
        .LOG_system$buf: align = 0x800 fill = 0xffffffff {} > IRAM
        
        /* trace buffer */
        .trace$buf: align = 0x800 fill = 0xffffffff {} > IRAM
        
        /* myLog buffer */
        .myLog$buf: align = 0x800 fill = 0xffffffff {} > IRAM
        ...
        .inStreamSrc$bufs: {} > IRAM
        
        .outStreamSrc$bufs: {} > IRAM
        
        .inStreamSink$bufs: {} > IRAM
        
        .outStreamSink$bufs: {} > IRAM
